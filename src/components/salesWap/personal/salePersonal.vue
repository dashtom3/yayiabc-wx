  ...
  <div class="salesPerson-container">
    ...
    <div class="sale-details">
      <div class="sale-btn-container">
        <div class="sale-btn">
          <p class="sale-btn-item primary-color">{{saleInfo.money || 0}}</p>
        ...
        <div class="sale-btn" @click="goPage('walletDetail')">
          <p class="sale-btn-item ">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      goMyCustomer() {
//        this.$store.dispatch('sale/IS_MINE_FIND', 1)
        this.$router.push({path: '/myCustomer', query: {backJudge: 'salePersonal'}})
      },
    }
  }
</script>
...
<style scoped lang="scss" rel="stylesheet/scss">
  ...
  .salesPerson-container {
    ...
    .sale-details {
      position: relative;
      width: 100%;
      border-bottom: px2vw(6) solid #e5e5e5;
      &:after {
        content: '';
        position: absolute;
        top: px2vw(-10);
